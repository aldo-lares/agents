 ...
 * 
 * For non-API requests, this middleware passes them through to normal Astro handling.
 * For API requests, it forwards them to the configured backend server.
 * 
 * @param context - The Astro context object containing the request
 * @param next - Function to continue to the next middleware or handler
 * @returns Promise<Response> - The response from the API server or next handler
 */
